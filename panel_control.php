                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="info">
                            ...
                            <a class="d-block">Usuario: <?php echo $_SESSION["nombre"]." ".$_SESSION["apellido_pat"]." ".$_SESSION["apellido_mat"];?></a>
                        </div>
                    </div>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $ruta_absoluta;?>/usuario.php" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo $ruta_absoluta;?>/producto.php?pagina=1" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo $ruta_absoluta;?>/almacen.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo $ruta_absoluta;?>/tienda.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
