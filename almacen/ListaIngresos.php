                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="res_bus_ingreso" class="res_bus_ingreso">
                            ...
                            $res=mysqli_query($conectador,"SELECT producto.id_producto, descripcion, categoria, talla, precio, color, cantidad, fecha_hora, id_ingreso
FROM ingreso_almacen
JOIN producto
WHERE producto.id_producto=ingreso_almacen.id_producto and id_almacen=$id_almacen");
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button onclick="EliIngreso(<?php echo $f[8]; ?>);" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php
