...
$tallas_sql=mysqli_query($conectador,"SELECT DISTINCT talla FROM stock_tienda JOIN producto ON producto.id_producto=stock_tienda.id_producto WHERE id_tienda=$tienda_detalle[0]");
...
ON stock_tienda.id_producto=producto.id_producto where id_tienda=$tienda_detalle[0] limit $inicio,50");
                            ...
                            <tr>
                                ...
                                while($tallas=mysqli_fetch_array($tallas_sql)){
                                    ...
                                    $productos_cant_sql=mysqli_query($conectador,"SELECT sum(stock) FROM stock_tienda JOIN producto ON producto.id_producto=stock_tienda.id_producto WHERE id_tienda=$tienda_detalle[0] and descripcion='$f[0]' and talla='$tallas[0]'");
