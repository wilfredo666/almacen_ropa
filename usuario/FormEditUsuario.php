...
<form action="" id="form_edit_usuario" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col">
            <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre(s)" value="<?php echo $f[4];?>"/>
            <br>
            <input type="text" name="apellido_p" id="apellido_p" class="form-control" placeholder="Apellido paterno" value="<?php echo $f[5];?>"/>
            <br>
            <input type="text" name="apellido_m" id="apellido_m" class="form-control" placeholder="Apellido materno" value="<?php echo $f[6];?>"/>
            <br>
            <input type="number" name="ci" id="ci" class="form-control" placeholder="CI" value="<?php echo $f[7];?>"/>
        </div>
        <div class="col">
